  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 p-10 md:p-12 text-center border border-slate-100"
      >
        {/* 로고 영역 */}
        ...
        <div className="space-y-3 mb-10">
          ...
          <div className="flex items-center justify-center gap-2 text-indigo-600 font-bold text-sm bg-indigo-50 w-fit mx-auto px-4 py-1.5 rounded-full">
            <ShieldCheck className="w-4 h-4" />
            Admin Access
          </div>
          <p className="text-slate-400 font-medium text-sm pt-2 leading-relaxed">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-4 px-6 bg-slate-900 text-white rounded-2xl font-black hover:bg-slate-800 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-slate-200"
        >
