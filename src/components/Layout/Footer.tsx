...
export default function Footer() {
  return (
    <footer className="flex shrink-0 border-t border-slate-100 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md px-6 py-2 items-center justify-center gap-4">
      <Link
        href="/help"
